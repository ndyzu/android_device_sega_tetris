...
$(call inherit-product-if-exists, vendor/sega/tetris/tetris-vendor.mk)
...
DEVICE_PACKAGE_OVERLAYS += device/sega/tetris/overlay


ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/sega/tetris/kernel
else
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/init.dummy.rc:root/init.tetris.rc \
